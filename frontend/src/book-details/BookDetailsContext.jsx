...
import { useSavedBooks } from "/src/components/Saved/SavedBooksContext"; // make sure path is correct
...
export function useBookDetails() {
    ...
    if (!ctx) {
        throw new Error(
            "useBookDetails must be used inside BookDetailsProvider"
        );
    }
    return ctx;
}
...
function BookDetailsOverlay() {
    ...
    // Use the SAME normalized ID logic as in SavedBooksContext
    const normalizedId =
        book.id ||
                ...
                {"★".repeat(Math.round(book.rating || 0)) +
                  ...
                  {book.rating.toFixed(2)}/5
                        ...
                        <div className="bd-actions">
                            <button className="btn-ghost" onClick={handleToggleSave}>
